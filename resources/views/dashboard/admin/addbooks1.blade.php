        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('admin/createaddbook/'.$add_books->ref_no) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="file" @error('books')
                        @enderror value="{{ old('books') }}" class="form-control" name="books">
                      </div>
    ...
    $(function() {
      ...
      $('.toastsDefaultFullImage').click(function() {
        $(document).Toasts('create', {
          ...
          class: 'bg-danger', 
          subtitle: 'Subtitle',
          image: '{{ asset('/public/../'.Auth::guard('admin')->user()->books)}}',
