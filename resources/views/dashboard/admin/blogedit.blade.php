              ...
              <div class="card-body">
                <form action="{{ url('admin/updateblog/'.$edit_blogs->ref_no) }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                       <textarea class="textarea" name="reference" class="form-control" @error('reference') is-invalid @enderror" placeholder="Add Reference"
                      value=""     style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{!! $edit_blogs->reference!!}</textarea>
                     </div>
                      @error('reference')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" @error('postdate')
                        @enderror value="{{ $edit_blogs->postdate }}" name="postdate" placeholder="postdate">
                      </div>
                    </div>
                    @error('postdate')
                    <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ $edit_blogs->author }}" name="author" placeholder="Author">
                      </div>
                    </div>
                    @error('author')
                    <span class="text-danger">{{ $message }}</span>
