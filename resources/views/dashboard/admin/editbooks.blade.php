        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('admin/updatebook/'.$edit_books->ref_no) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ $edit_books->title }}" name="title" placeholder="Title">
                      </div>
                    </div>
                    @error('title')
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ $edit_books->ownersname }}" name="ownersname" placeholder="Youtube Link">
                      </div>
                    </div>
                    @error('ownersname')
                    <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <img style="width: 50%; height: 50%;" class="profile-user-img img-fluid"
                            src="{{ URL::asset("/public/../$edit_books->images")}}"
                    ...
                    <div class="col-sm-6">
                      ...
                      value="{{ old('messages') }}     style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $edit_books->messages }}</textarea>
                     </div>
                      @error('messages')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
