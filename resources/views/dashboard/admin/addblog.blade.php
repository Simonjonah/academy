                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ old('author') }}" name="author" placeholder="Author">
                      </div>
                    </div>
                    @error('author')
                    <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ old('postdate') }}" name="postdate" placeholder="postdate">
                      </div>
                    </div>
                    @error('postdate')
                    <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                      ...
                      value="{{ old('reference') }}     style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                     </div>
                      @error('reference')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
