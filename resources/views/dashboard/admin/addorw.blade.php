        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('admin/createorw') }}" method="post" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="row">
                    ...
                    <!-- <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ old('amount') }}" name="amount" placeholder="amount">
                      </div>
                    </div>
                    @error('amount')
                    <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ old('ownersname') }}" name="ownersname" placeholder="YouTube Link">
                      </div>
                    </div>
                    @error('ownersname')
                    <span class="text-danger">{{ $message }}</span>
