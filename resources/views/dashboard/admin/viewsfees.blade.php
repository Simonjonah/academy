          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                    ...
                    <small class="float-right">Date: {{ $view_payments->created_at->format('D d, M Y, H:i') }}</small>
                  </h4>
                </div>
                <!-- /.col -->
              </div>
              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    <tbody>
                    <tr>
                      <td>{{ $view_payments->name }}</td>
                      <td>{{ $view_payments->phone  }}</td>
                      <td>{{ $view_payments->email  }}</td>
          
                      <td>₦ {{ $view_payments->amount }}</td>
                    </tr>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      <tr>
                        ...
                        <td>{{ $view_payments->book['title']  }}</td>
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="{{ url('admin/print1stinglepaymentspdf/'.$view_payments->ref_no) }}" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
