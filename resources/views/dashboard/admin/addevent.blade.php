                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <option value="Capacity Training">Capacity Training</option>
                        
                        <option value="Empowering women through small-scale businesses">Empowering women through small-scale businesses</option>
                    </select>
                      </div>
                    </div>
                    @error('title')
