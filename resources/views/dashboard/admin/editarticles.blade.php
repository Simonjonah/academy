        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('admin/updateearticle/'.$edit_articles->ref_no) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ $edit_articles->title }}" name="title" placeholder="Title">
                      </div>
                    </div>
                    @error('title')
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" @error('ownersname')
                        @enderror value="{{ $edit_articles->ownersname }}" name="ownersname" placeholder="Youtube Link">
                      </div>
                    </div>
                    @error('ownersname')
                    <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                    <td> <img style="width: 100px; height: 50px" src="{{ URL::asset("/public/../$edit_articles->images")}}" alt=""></td>
                    ...
                    <div class="col-sm-6">
                      ...
                      value="{{ old('messages') }}     style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $edit_articles->messages }}</textarea>
                     </div>
                      @error('messages')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
