@include('pages.header')
        ...
        <div class="edu-breadcrumb-area">
            ...
            <ul class="shape-group">
                ...
                <li class="shape-2 scene"><img data-depth="2" src="front/assets/images/about/shape-13.png" alt="shape"></li>
                <li class="shape-3 scene"><img data-depth="-2" src="front/assets/images/about/shape-15.png" alt="shape"></li>
                <li class="shape-4">
                    <span></span>
                </li>
                <li class="shape-5 scene"><img data-depth="2" src="front/assets/images/about/shape-07.png" alt="shape"></li>
            </ul>
        </div>
        ...
        <!--=====================================-->
        <section class="contact-us-area" style="margin-bottom: 30px;">
            <div class="container">
                <div class="row g-5">
                    ...
                    <div class="offset-xl-2 col-lg-6">
                        <div class="contact-form form-style-2">
                            ...
                            <ul class="shape-group">
                                <li class="shape-1 scene"><img data-depth="1" src="front/assets/images/about/shape-13.png" alt="Shape"></li>
                                <li class="shape-2 scene"><img data-depth="-1" src="front/assets/images/counterup/shape-02.png" alt="Shape"></li>
                            </ul>
                        </div>
                    </div>
                </div>
